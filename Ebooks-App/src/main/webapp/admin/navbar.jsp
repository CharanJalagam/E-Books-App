	...
	<div class="row">
		...
		<div class="col-md-6">
			<form class="form-inline my-2 my-lg-0">
				...
				<input class="btn btn-primary my-2 my-sm-0" type="hidden">
		...
		<i class="fas fa-user">&nbsp</i>${userobj.name }
		</a>
		<a data-toggle="modal" data-target="#exampleModalCenter"
				class="btn btn-primary text-white"><i class="fa-solid fa-right-from-bracket">&nbsp</i>Logout</a>
		
		</c:if>
		<c:if test="${empty userobj }">
		<a href="../login.jsp" class="btn btn-success">
		<i class="fa-solid fa-user">&nbsp</i>Login</a>
